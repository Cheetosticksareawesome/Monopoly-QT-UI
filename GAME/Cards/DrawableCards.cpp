...
Card TaskFailedSuccessfully{"Task Failed Successfully", "Your dog dug up a gem worth $450, but the IRS wants half. Collect $225", EffectType::EditMoney, 100, 0, true, false};
...
Card SpeedingFine{"Speeding Fine", "Your dog chased a car and you got the ticket. Pay $50", EffectType::EditMoney, -150, 0, true, false};
Card LostWallet{"Lost Wallet", "You lost your wallet at the station. Lose $75", EffectType::EditMoney, -200, 0, true, false};
Card TreasureMap{"Treasure Map", "Your questionable treasure map actually worked. Collect $150", EffectType::EditMoney, 75, 0, true, false};
Card StockSale{"Sale of Stock", "From selling stock, you earned $150", EffectType::EditMoney, 125, 0, false, true};
